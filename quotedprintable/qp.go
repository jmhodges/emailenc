// Copyright 2014 Jeff Hodges. Copied out of golang's mime/multipart
...
// NewReader returns a new Reader that decodes quoted-printable data
// as it is read. If the reader passed in is not a *bufio.Reader, it
// will wrap it in one.
